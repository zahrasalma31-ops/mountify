        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div>
                    ...
                    <input type="" id="nama" name="nama" class="form-control" autocomplete="off" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea name="detail" id="detail" cols="30" rows="10" class="form-contol"></textarea>
                </div>
                <div>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                     <a href="detail_produk.php?p=<?php echo $data['id']; ?>" class="btn btn-info"><i class="fas fa-search"></i></a>
                                </td>
                            </tr>
                    <?php
                            $jumlah++; 
