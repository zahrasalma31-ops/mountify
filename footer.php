<div class="container-fluid py-5 content-subscribe text-light">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-1 d-flex justify-content-center mb-2">
                <a href="http://instagram.com/zahramylndaaa"><i class="fab fa-instagram fs-2"></i></a>
            </div>
            <div class="col-sm-1 d-flex justify-content-center mb-2">
                <a href="http://x.com/vegarchive"><i class="fab fa-twitter fs-2"></i></a>
            </div>
            <div class="col-sm-1 d-flex justify-content-center mb-2">
                <a href="http://www.tiktok.com/@favviftiesz"><i class="fab fa-tiktok fs-2"></i></a>
            </div>
        </div>
    </div>
</div>
